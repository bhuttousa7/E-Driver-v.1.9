...
public class FusedLocationServiceAllTime extends Service
    ...
    private static final long UPDATE_INTERVAL = 5000, FASTEST_INTERVAL = 5000; // = 10 seconds
    ...
    public void onLocationChanged(Location location) {
        if (location != null) {
            ...
            longitude=location.getLongitude();
            Intent i = new Intent(Constants.MY_BROADCAST_ACTION_KEY_All_Time);
