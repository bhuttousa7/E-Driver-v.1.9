 ...
 */
public class AddRoutes extends Fragment implements OnMapReadyCallback, response_interface {
    ...
    DragLinearLayout stops_layout,stops_layoutNoWaypoint;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        stops_layoutNoWaypoint = v.findViewById(R.id.stopslayout);
...
//                stopsview.setOnClickListener(new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//                        EditText nextChild = v.findViewById(R.id.edt_location);
//                        nextChild.setOnClickListener(new View.OnClickListener() {
//                            @Override
//                            public void onClick(View v) {
//                                EditText editText1=v.findViewById(R.id.edt_location);
...
//
        ...
        uploadRoute.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    if (!editTextRouteName.getText().toString().equals("") && orgLat != 0.0 && orgLong != 0.0 && destLat != 0.0 && destLng != 0.0) {
...
//                                TextView txtview_stops = stopsview.findViewById(R.id.text_stoplocation);
//                                ImageButton cross = stopsview.findViewById(R.id.cross);
//
//                                cross.setOnClickListener(new View.OnClickListener() {
//                                    @Override
...
//                                        //    Toast.makeText(getContext(), "" + position, Toast.LENGTH_SHORT).show();
//                                        removePoint(position);
//                                        removeStops(position);
//                                        if (orgLong != 0 && orgLat != 0 && destLng != 0 && destLat != 0) {
//                                            createRoute();
//                                        }
//                                    }
//                                });
//                                stops_layoutNoWaypoint.addView(stopsview);
//                                for(int j = 0; j < stops_layoutNoWaypoint.getChildCount(); j++){
//                                    View child = stops_layoutNoWaypoint.getChildAt(j);
//                                    // the child will act as its own drag handle
//                                    stops_layoutNoWaypoint.setViewDraggable(child, child);
//                                }
//                                int position = stops_layoutNoWaypoint.indexOfChild(stopsview);
//                                stopsview.setTag(position);
//                                stopsview.findViewById(R.id.text_stoplocation).setTag(position);
//                                stopsview.findViewById(R.id.cross).setTag(position);
//                                txtview_stops.setText(address);
//
//                               // stops_layoutNoWaypoint.addView(txtview_stops);
//
...
//                                new code end
//                                int pos = stops_layoutNoWaypoint.indexOfChild(txtview_stops);
//                                txtview_stops.setTag(pos);
//                                txtview_stops.setOnClickListener(new View.OnClickListener() {
//                                    @Override
//                                    public void onClick(View v) {
////                                        stops_layoutNoWaypoint.removeView(stops_layoutNoWaypoint.findViewWithTag(v.getTag()));
////                                        if (orgLong != 0 && orgLat != 0 && destLng != 0 && destLat != 0) {
////                                            stopslist.remove(v.getTag());
////                                            createRoute();
////                                        }
//                                    }
//                                });
        ...
        for (int k = 0; k < AllPoints.size(); k++) {
            try {
                ...
                if(stopsHash.get("typeid").equals("4"))
                {
                    ...
                    mMap.addMarker(new MarkerOptions().position(new LatLng(stoplat, stoplng)).icon(BitmapDescriptorFactory.fromResource(R.drawable.stopmap)).title("Fuel Station"));

                }else if(stopsHash.get("typeid").equals("5"))
                {
                    double stoplat = Double.parseDouble(stopsHash.get("stoplat").toString());
                    double stoplng = Double.parseDouble(stopsHash.get("stoplng").toString());
                    mMap.addMarker(new MarkerOptions().position(new LatLng(stoplat, stoplng)).icon(BitmapDescriptorFactory.fromResource(R.drawable.food)).title("Restaurant"));
                ...
                else if(stopsHash.get("typeid").equals("6"))
                {
                    double stoplat = Double.parseDouble(stopsHash.get("stoplat").toString());
                    double stoplng = Double.parseDouble(stopsHash.get("stoplng").toString());
                    mMap.addMarker(new MarkerOptions().position(new LatLng(stoplat, stoplng)).icon(BitmapDescriptorFactory.fromResource(R.drawable.restarea)).title("Rest Area"));
